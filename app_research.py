...
def send_revision_instructions(
    graph: CompiledStateGraph, partial_state: State, containers: Tuple[DeltaGenerator]
) -> None:
...
def check_template(containers: Tuple[DeltaGenerator]) -> None:
