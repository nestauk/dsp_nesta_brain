...
if PROJECT == "NESTA_BRAIN":
    ...
    if ALLOW_POLICY_DOCS:
        DB_PATH: str = "retrieval/db/knowledge_bases/test"  # nesta_brain"
    else:
        DB_PATH: str = "retrieval/db/knowledge_bases/test"  # full_site_demo_db_with_pdfs"
...
if PROJECT == "POLICY_ATLAS":
    ...
    DB_PATH: str = "retrieval/db/knowledge_bases/test"  # policy_atlas"
