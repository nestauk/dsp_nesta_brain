...
qa_system_prompt_test = """
    ...
    Finally, for each sentence, you must provide Citations to justify your answer. Cite the integer Source ID of the SPECIFIC piece(s) of context which justify your answer in square brackets.

    Context:
    {context}
    """  # noqa

qa_prompt_test = ChatPromptTemplate.from_messages(
    [
        ("system", qa_system_prompt_test),
        MessagesPlaceholder("chat_history"),
        ("human", "{input}"),
    ]
)
