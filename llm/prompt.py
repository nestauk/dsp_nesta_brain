...
if PROJECT == "NESTA_BRAIN":
    ...
    verbatim_prompt = """
        ...
        For every bullet point you write, provide the verbatim context that supports your answer. Format the verbatim text as a blockquote in markdown. At the end of the verbatim text, cite the number(s) of the piece(s) of context you used to derive it in square brackets.
